...
Usage:
    ...
    # Single query mode
    python -m customer_support.main --query "How do I reset my password?"

    # Batch mode from file
    python -m customer_support.main --file queries.txt
"""
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="AI Customer Support Agent powered by CrewAI"
    )
    parser.add_argument(
        "--query", "-q",
        type=str,
...
def _process_query(query: str, classify_only: bool = False) -> None:
    ...
    from customer_support.crew import classify_inquiry, handle_inquiry
