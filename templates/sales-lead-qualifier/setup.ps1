# Sales Lead Qualifier Agent Template - Setup Script (Windows)
# Usage: .\setup.ps1
$ErrorActionPreference = "Stop"

Write-Host "==========================================" -ForegroundColor Cyan
Write-Host "  Sales Lead Qualifier Agent - Setup" -ForegroundColor Cyan
Write-Host "==========================================" -ForegroundColor Cyan
...
Write-Host "  Run:       python -m sales_lead_qualifier"
