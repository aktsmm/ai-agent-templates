# Legal Document Analyzer Agent Template - Setup Script (Windows)
# Usage: .\setup.ps1
$ErrorActionPreference = "Stop"

Write-Host "==========================================" -ForegroundColor Cyan
Write-Host "  Legal Document Analyzer Agent - Setup" -ForegroundColor Cyan
Write-Host "==========================================" -ForegroundColor Cyan
...
Write-Host "  Run:       python -m legal_document_analyzer"
